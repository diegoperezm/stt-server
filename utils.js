"use strict";
const grammarXstate = require("./public/javascripts/grammarXstate");
const grammarDagreD3 = require("./public/javascripts/grammarDagreD3");
const dagreD3 = require("./public/javascripts/dagre-d3.min.js");
...
function createGraph(graphData) {
  ...
  let edgeList = parserDagredD3.parse(graphData.stateTransitionTable);
  ...
  edges.forEach(function (ele) {
    g.setEdge({ v: ele[0], w: ele[1], name: ele[3] }, { label: ele[2] });
  });
...
function renderGraph(g, graphData) {
  ...
  svg.attr(
    "height",
    svgGraphInfo.height - window.innerHeight / graphData.initialScaleH
  );
}
